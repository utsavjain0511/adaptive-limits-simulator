...
- **Knob changes re-instantiate the limiter** (state resets to the initial limit) — simpler than live-mutating config, and the small jump in the limit line is visible and honest.
