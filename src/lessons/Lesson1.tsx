...
export function Lesson1() {
  ...
  return (
    <LessonLayout spec={SPEC} lab={lab}
      ...
      watch={[
        'Without shedding, in-flight piles up into the thousands until clients give up waiting, every request waits behind the backlog, p99 blows past the 1 s client deadline, and goodput falls to zero — the server is 100% busy doing work nobody is waiting for.',
